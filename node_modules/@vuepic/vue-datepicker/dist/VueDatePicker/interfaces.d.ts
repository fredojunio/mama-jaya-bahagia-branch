...
export declare enum OpenPosition {
    center = "center",
    left = "left",
    right = "right"
}
...
export type ModelValue = Date | Date[] | string | string[] | TimeModel | TimeModel[] | MonthModel | MonthModel[] | number | number[] | null;
...
export type DatepickerMenuRef = ComponentPublicInstance<{
    updateMonthYear: (ins: number, val: {
        month: number | null;
        year: number | null;
    }) => void;
}>;
